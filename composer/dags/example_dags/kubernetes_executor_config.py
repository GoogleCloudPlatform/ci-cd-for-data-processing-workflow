...
default_args = {'owner': 'jferriero@google.com', 'start_date': days_ago(2)}

with DAG(dag_id='kubernetes_executor_config',
    ...
    other_ns_task = PythonOperator(task_id="other_namespace_task",
                                   python_callable=print_stuff,
                                   executor_config={
                                       "KubernetesExecutor": {
